...
$language = [];//language is in checkbox so array format used
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST["about"])) {
        ...
        $about = "Users too lazy to write an about."; 
    }
}
...
<head>
    ...
    <style>
        ...
        .form-row:last-child { 
            justify-content: center; /* to make the submit button appear on the middle*/
